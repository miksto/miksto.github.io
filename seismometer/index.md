...
This seismometer is based on the TC1 seismometer, and while the choice of materials differ the basic constructions principles are very much alike. 

## The frame
In an attempt to minimize RF noise, the frame was chosen to be a rolled up metal mesh.  It came in a plastic wrapping which I kept on to protect the seismomter from drafts.
Since we will have magnets inside this tube, make sure the metal mesh and any nuts and skrews are made of a non magnetic material. 
...
The coil is wound with an AWG 18 wire around an empty tape role, with a large enough inner diameter for the neodymium magnets to pass through with some margin. The desired resistance of the coil is 700 ohms to 2000 ohms according to the TC1 webpage.
...
## The dampener
A dampener is required to prevent the seismometer to be overly sensitive in its resonant frequency. Without a dampener even just a small vibration will cause the spring to bounce up and down for a very long time.
